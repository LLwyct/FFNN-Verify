...
class Network:
    ...
    def init(self):
        self.spec.load(self.propertyIndexReadyToVerify, "acas")
        self.lmodel.initLayerModel(self.networkFilePath, self.netFmtType)
    ...
    #     self.inputLmodel.bound_equations["out"]["lb"] = LinearFunction(np.identity(inputLayerSize), np.zeros(inputLayerSize))
    #     self.inputLmodel.bound_equations["out"]["ub"] = LinearFunction(np.identity(inputLayerSize), np.zeros(inputLayerSize))
    ...
    #     inputLayerSize = self.inputLmodel.size
    #     self.inputLmodel.bound_equations["out"]["lb"] = LinearFunction(np.identity(inputLayerSize),
    #                                                                     np.zeros(inputLayerSize))
    #     self.inputLmodel.bound_equations["out"]["ub"] = LinearFunction(np.identity(inputLayerSize),
    #                                                                     np.zeros(inputLayerSize))

    #     self.inputLmodel.bound_equations_cmp["out"]["lb"] = LinearFunction(np.identity(inputLayerSize),
    #                                                                     np.zeros(inputLayerSize))
    #     self.inputLmodel.bound_equations_cmp["out"]["ub"] = LinearFunction(np.identity(inputLayerSize),
    #                                                                      np.zeros(inputLayerSize))
    #     preLayer = self.inputLmodel
    #     for layer in self.lmodel:
    #         if layer.type == "relu":
